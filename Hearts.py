...
class Hearts:
        def __init__(self):
                ...
                self.passes = [1, -1, 2, -2, 0] # left, right, across, no pass
                ...
                self.players = [Player("Danny"), Player("Desmond"), Player("Ben"), Player("Tyler"), Player("Sally")]
        ...
        def dealCards(self):
                ...
                while(self.deck.size() > 0):
                        ...
                        #self.players[i / 10].addCard(self.deck.deal()) #for debug if one's cards are all heart.
                        i += 1
        ...
        def playersPassCards(self):
                ...
                self.printPlayers()
                if not self.trickNum % 5 == 4: # don't pass every fifth hand
